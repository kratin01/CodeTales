...
import ShimmerUI from "../../component/admin/ShimmerUI/ShimmerUI_Comments";
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`shadow-custom-sm border rounded-full px-4 py-1 cursor-pointer text-xs ${
              filter === "Approved" ? "text-blue-700" : "text-primary"
            }`}
          >
            Approved
          </button>
          ...
          <button
            ...
            className={`shadow-custom-sm border rounded-full px-4 py-1 cursor-pointer text-xs ${
              filter === "Not Approved" ? "text-blue-700" : "text-primary"
            }`}
          >
            Not Approved
          </button>
